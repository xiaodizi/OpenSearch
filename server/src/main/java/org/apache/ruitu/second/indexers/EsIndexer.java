...
package org.apache.ruitu.second.indexers;
...
import org.apache.ruitu.second.ElasticSecondaryIndex;
...
public class EsIndexer extends NoOpIndexer {
    ...
    public void insertRow(Row row) {
        ...
        logger.debug("{} insertRow "+id+" took {}ms", index.index_name,  time.elapsed(TimeUnit.MILLISECONDS));
    }
