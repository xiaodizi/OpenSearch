...
public class ElasticIndex {
    ...
    public void indexData(Map<String, Object> maps, String indexName, String primaryKeyValue, Boolean asyncWrite) {
        // 索引数据
        try {
            String json = "{ \"index\" : { \"_index\" : \"" + indexName + "\", \"_id\" : \"" + primaryKeyValue + "\" } }\n" + JSON.toJSONString(maps) + "\n";
            bulkIndexData(indexName, json, asyncWrite);
...
//            }
    ...
    private static Boolean bulkIndexData(String index, String json, Boolean asyncWrite) throws IOException {
        //?filter_path=errors
